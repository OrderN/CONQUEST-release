...
filename_gto_write='ClCQ.gto_TZTP_3G_guess' 
# file to read in order to build an initial guess (not mandatory)
#filename_gto_read ='ClCQ.gto_TZTP_3G_guess' 
...
orb[1].guess = array([0.162353,0.578204,1,1,2,2])    #1.651 and 4.446 
#orb[1].guess = array([0.071943,0.047778,0.4,0.237344,0.1,0.1])
#orb[0].guess = array([-1, 0.1, 0.5, -0.1])
...
orb[4].guess = array([1.673191,0.328955,0.225643,0.139717,0.027,4.110])
...
orb[0].bounds=([-6,6])
orb[1].bounds=([-1,-1,-6,-6,-1,-6],[1,1,2,2,6,6])
orb[2].bounds=([-1,-1,-6,-6,-1,-6],[1,1,2,2,6,6])
orb[3].bounds=([-2,4])
orb[4].bounds=([-2,4.110])
orb[5].bounds=([-2,4.110])
orb[6].bounds=([-2,6])
orb[7].bounds=([-2,6])
orb[8].bounds=([-6,6])
