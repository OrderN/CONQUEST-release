...
#orb[8].guess = array([3.155396,0.423250,0.501348,-0.663974,0.031197,0.198817])
...
orb[0].bounds = ([-4,4])  #Bounds for SZ,SZP,DZP,TZTP
orb[5].bounds=([-1,-1,0,-6,-1,-6],[3.5,2,3,3,6,6])  #Bounds for DZP,TZTP
orb[7].bounds=([-1,-1,2,-6,-1,-6],[2,2,3,3,6,6])    #Bounds for TZTP
