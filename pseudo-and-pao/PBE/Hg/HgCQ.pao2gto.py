...
#orb[8].guess = array([-3.3785345,1.03796059,2.50785159,2.28419328,-3.3785345,1.03796059])
#orb[9].guess = array([1.774463,0.364851,1.036166,-1.341885,0.089941,0.145736])
#orb[10].guess = array([-3.3785345,1.03796059,2.50785159,2.28419328,-3.3785345,1.03796059])

orb[0].bounds = ([-6,6])  #Activation on SZ,SZP,DZP,TZTP
orb[1].bounds = ([-6,6])  #Activation on SZ,SZP,DZP,TZTP
#orb[2].bounds = ([-10,10])
#orb[3].bounds = ([-6,6])
#orb[4].bounds = ([-6,6])    
#orb[5].bounds = ([-10,10])
#orb[6].bounds = ([-10,10])#Activation on DZP
#orb[7].bounds=([-5,4])
#orb[8].bounds=([-6,6])    #Activation on TZTP
#orb[9].bounds = ([-6,6])  #Activation on TZTP
#orb[10].bounds = ([-6,6]) #Activation on TZTP
