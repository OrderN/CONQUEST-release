...
#orb[1].guess = array([ 0.1,-1,5,-1])
#orb[2].guess = array([ 0.1,-1.5,-1,1,1,1])
#orb[1].guess = array([1.0,5.730031,1.240317,3.047719,3,3])
...
orb[0].bounds=([-6,4])     #Bounds for SZ,SZP,DZP,TZTP
orb[1].bounds=([-6,6])     #Bounds for SZ,SZP,DZP,TZTP
orb[2].bounds=([-11,11])    #Bounds for SZP,DZP,TZTP
orb[4].bounds=([-11,11])   #Bounds for DZP,TZTP
orb[6].bounds=([-6,11])    #Bounds for TZTP
orb[7].bounds=([-6,12])    #Bounds for TZTP
orb[8].bounds=([-6,16])   #Bounds for TZTP
...
#Plot the radial part only to test the fit parameters with lm and Gauss-Newton algorithms 
