...
#orb[2].guess = array([0.141962,0.8,1.866316,0,1,1])
#orb[3].guess = array([1.334561,0.768038,0.411721,-0,0.045863,0.290136])
#orb[4].guess = array([1.0,0.389613,0.389613,0.054788,0.1,0.1])  
#orb[5].guess = array([1.0,0.389613,0.389613,0.054788,0.1,0.1])
#orb[6].guess = array([1.0,0.389613,0.389613,0.054788,0.1,0.1])
...
#orb[2].bounds = ([-0.5,1])  #For SZP
#orb[2].bounds = ([-1,6])  #Bounds for SZ
orb[2].bounds = ([-3,6])  #Bounds for DZP,TZTP
orb[3].bounds = ([-6,6])   #Bounds for SZP,TZTP
#orb[3].bounds = ([-1,6])  #Bounds for DZP
orb[4].bounds = ([-1.5,1.5])  #Bounds for DZP,TZTP
orb[5].bounds = ([-1.5,1.5])  #Bounds for DZP,TZTP
orb[6].bounds = ([-1.5,1.5]) #Bounds for TZTP
orb[7].bounds=([-5,4])       #Bounds for TZTP
orb[8].bounds=([-6,6])       #Bounds for TZTP
orb[9].bounds = ([-6,3.5])   #Bounds for TZTP
