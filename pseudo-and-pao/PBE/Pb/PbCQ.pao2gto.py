...
#filename_gto_read ='PbCQ.gto_SZ_3G_guess' 
...
orb[2].guess = array([0.141962,0.8,1.866316,-1.199485,1,1])
...
orb[2].bounds = ([-6,10])
orb[3].bounds = ([-6,6])
orb[4].bounds = ([-1.5,1.5])    #Activation on TZTP
orb[5].bounds = ([-1.5,1.5])
orb[6].bounds = ([-1.5,1.5])
orb[7].bounds=([-5,4])
orb[8].bounds=([-6,6])
orb[9].bounds = ([-6,3.5])
