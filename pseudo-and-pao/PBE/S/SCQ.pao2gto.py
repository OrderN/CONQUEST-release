...
#orb[0].guess = array([0.126258,0.498409,1.997778,-0.974771,0.1,0.1])
#orb[1].guess = array([0.338656,0.724668,0.059010,0.024104,1,0.1])    #1.651 and 4.446 
#orb[1].guess = array([0.344563,0.930416,0.849361,-1.985458])
#orb[2].guess = array([1.509871,0.481194,0.277398,0.218251,1,1])
#orb[3].guess = array([0.290540,0.641397,1,1,1,1])  #,0.397064,2.630277
#orb[4].guess = array([1.509925,0.481181,0.277398,0.375492,1,1])
#orb[5].guess = array([0.424704,1.060714,1,1,1,1])
...
orb[0].bounds=([-6,6])    #Bounds for SZ,SZP,DZP and TZTP
orb[1].bounds=([-1,-1,-1,-1,1,-6],[1,3,3,3,3,3]) ##Bounds for SZ,SZP,DZP and TZTP
orb[2].bounds=([-3,6]) #Bounds for SZP,DZP,TZTP
orb[3].bounds=([-1,-1,1,1,-6,-6],[1,3,3,3,3,3]) #Bounds for DZP,TZTP
orb[4].bounds=([1,-1,-1,-1,1,-6],[6,3,3,3,6,6]) #Bounds for DZP,TZTP
orb[5].bounds=([-2,-2,1,1,-1,-1],[3,3,6,6,3,3]) 
