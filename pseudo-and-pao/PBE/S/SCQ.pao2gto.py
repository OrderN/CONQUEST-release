...
filename_gto_write='SCQ.gto_TZTP_3G_guess' 
# file to read in order to build an initial guess (not mandatory)
#filename_gto_read ='SCQ.gto_DZP_3G_guess' 
...
orb[0].bounds=([-6,6])
orb[1].bounds=([-1,-1,-1,-1,1,-6],[1,3,3,3,3,3])
orb[2].bounds=([-3,6])
orb[3].bounds=([-1,-1,1,1,-6,-6],[1,3,3,3,3,3])
orb[4].bounds=([1,-1,-1,-1,1,-6],[6,3,3,3,6,6])
orb[5].bounds=([-2,-2,1,1,-1,-1],[3,3,6,6,3,3]) 
orb[6].bounds=([-1.5,2])
orb[7].bounds=([-1,-2,-1,-6,2,-6],[3,3,3,3,6,6])
orb[8].bounds=([-1,-2,-1,-6,-6,-6],[3,3,3,3,6,2])
