...
#filename_gto_read ='SeCQ.gto_TZTP_3G_guess' 
...
orb[1].bounds = ([-3,10])
orb[2].bounds = ([-6,2.5])
orb[3].bounds = ([-3.2,3.5])
orb[4].bounds=([-1,-1,-6,-6,-1,-6],[3.5,2,6,3,6,1])
orb[5].bounds=([-1,-7,2.5,-6,0,-6],[3.5,1.5,4,3,6,6])
orb[6].bounds=([-1,-1,-1,-6,-1,-6],[3.5,2.6,3,3,6,6])
orb[7].bounds=([-1,-1,2,-6,-1,-6],[2,2.6,3,3,6,6])
orb[8].bounds=([-1,-6,2,-6,-1,-6],[6,2.6,3,3,6,6])
orb[9].bounds=([-1,-6,2,-6,-1,-6],[6,2.6,6,3,6,6])
