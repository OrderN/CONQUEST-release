...
#orb[0].guess = array([0.886520,-0.438524])
...
#orb[5].guess = array([2.062703,-0.89,3,-1.9,0.4,0.42])
...
#orb[9].guess = array([1.946750,-4.650267,2.5,-1.928747,0.7,2])



orb[1].bounds = ([-3,10])  #Bounds for SZ,SZP,DZP,TZTP
orb[2].bounds = ([-6,2.5]) #Bounds for SZ,SZP,DZP,TZTP
orb[3].bounds = ([-3.2,3.5])  #Bounds SZP,DZP,TZTP
orb[4].bounds=([-1,-1,-6,-6,-1,-6],[3.5,2,6,3,6,1])   #Bounds DZP,TZTP
orb[5].bounds=([-1,-7,2.5,-6,0,-6],[3.5,1.5,4,3,6,6]) #Bounds DZP,TZTP
orb[6].bounds=([-1,-1,-1,-6,-1,-6],[3.5,2.6,3,3,6,6]) #Bounds TZTP
orb[7].bounds=([-1,-1,2,-6,-1,-6],[2,2.6,3,3,6,6])    #Bounds TZTP
orb[8].bounds=([-1,-6,2,-6,-1,-6],[6,2.6,3,3,6,6])    #Bounds TZTP
orb[9].bounds=([-1,-6,2,-6,-1,-6],[6,2.6,6,3,6,6])    #Bounds TZTP
