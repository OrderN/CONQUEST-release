...
#orb[1].guess = array([0.190016,0.834360,1.581923,6.0,1.496103,-6.807199])
#orb[2].guess = array([0.190801,0.365229,1.864074,2.5,1.799920,-2.728576])
#orb[3].guess = array([0.173667,0.737546,2.041271,2,1.943546,-1])    
##orb[4].guess = array([3.155396,0.423250,0.501348,-0.663974,0.031197,0.198817])     
#orb[5].guess = array([3.155396,0.423250,1.5,-0.663974,0.031197,0.198817])
#orb[6].guess = array([3.155396,0.423250,0.501348,-0.663974,0.031197,0.198817])  
#orb[7].guess = array([2.791398, 0.307564, 0.223091,0.452752,1.79,4])
...
#orb[9].guess = array([ 0.1,-1.5,-1,1,1,1])


#orb[0].bounds = ([-6,6])
orb[1].bounds=([-1,-1,-6,-6,-1,-10],[1,2,6,6,6,6]) #Bounds for SZ,SZP,DZP,TZTP
orb[2].bounds = ([-6,3.5])  #Bounds for SZ,SZP,DZP,TZTP
orb[3].bounds = ([-6,10]) #Bounds SZP,DZP,TZTP
orb[4].bounds = ([-6,6])  #Bounds DZP,TZTP
orb[5].bounds=([-1,-6,1,-6,0,-6],[3.5,1.5,4,6,6,6]) #Bounds DZP,TZTP
orb[6].bounds = ([-1,3.5]) #Bounds TZTP
orb[7].bounds=([-6,6]) #Bounds TZTP
orb[8].bounds=([-6,6]) #Bounds TZTP
orb[9].bounds = ([-6,3.5]) #Bounds TZTP
