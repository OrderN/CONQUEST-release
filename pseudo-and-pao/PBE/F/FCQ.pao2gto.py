...
#orb[1].guess = array([1.144933,1.754652,3.554113,-0.455590,0.341243,0.544000])  
#orb[2].guess = array([1.832490,2.762798,2.535023,-2,0.560324,1.165598])
#orb[4].guess = array([ 0.1,-1.5,-1,1,1,1])
#orb[6].guess = array([8.288372,-6,1.427365,3.207276,10.0,8.911639])   
#orb[7].guess = array([0.260153,0.132615,1.346619,3.133500,10.0,4.138631])    
#orb[8].guess = array([0.358179,0.133078,1.634348,5.208750,12,5.258423])      

orb[0].bounds=([-6,6])      #Bounds for SZ,SZP,DZP,TZTP
orb[1].bounds=([-2,3.6])    #Bounds for SZ,SZP,DZP,TZTP
#orb[2].bounds=([-10,10])   #Bounds for SZP,DZP,TZTP
#orb[4].bounds=([-6,12])    #Bounds for DZP,TZTP
#orb[6].bounds=([-10,10])   #Bounds for TZTP
#orb[7].bounds=([-6,10])    #Bounds for TZTP
#orb[8].bounds=([-6,12])    #Bounds for TZTP
