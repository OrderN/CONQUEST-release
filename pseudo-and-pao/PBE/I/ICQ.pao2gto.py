...
#orb[0].guess = array([0.173667,0.737546,0.041271,0.1,1.943546,-0.1])
#orb[1].guess = array([0.173667,0.737546,0.041271,0.1,1.943546,-0.1])
#orb[2].guess = array([0.173667,0.737546,0.041271,0.1,1.943546,-0.1])
...
#orb[7].guess = array([3.155396,0.423250,2.501348,-0.663974,0.031197,0.198817])
...
orb[2].bounds = ([-6,6])  #bounds for SZP,DZP,TZTP
orb[3].bounds = ([-6,6])  #bounds for DZP,TZTP
orb[4].bounds = ([-6,6]) #bounds for DZP,TZTP
orb[5].bounds = ([-6,6]) #bounds for DZP,TZTP
orb[6].bounds = ([-1,3.5])  #bounds for TZTZP
orb[6].bounds = ([-1,3.5])  #bounds for TZTZP
orb[7].bounds=([-6,6])      #bounds for TZTZP
orb[8].bounds=([-6,6])      #bounds for TZTZP
...
#Plot to test the fit parameters with lm and Gauss-Newton algorithms 
