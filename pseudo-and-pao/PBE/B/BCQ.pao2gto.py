...
#orb[2].bounds=([-10,10])  #Bounds for SZP,DZP
orb[2].bounds=([-5,5])    #Bounds for TZTP orb[2]
orb[4].bounds=([-1,10])   #Bounds for DZP,TZTP
orb[5].bounds=([-1,10])   #Bounds for TZTP
