...
filename_gto_write='BiCQ.gto_DZP_3G' 
# file to read in order to build an initial guess (not mandatory)
filename_gto_read ='BiCQ.gto_DZP_3G_guess' 
...
orb[3].bounds = ([-4,4])    #Bounds for SZP,DZP,TZTP
orb[4].bounds = ([-6,3])    #Bounds for DZP, TZTP
#orb[5].bounds = ([-1.5,1.5]) #Bounds for TZTP
#orb[6].bounds = ([-1.5,1.5]) #Bounds for TZTP
