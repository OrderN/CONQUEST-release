...
#orb[4].guess = array([1.334561,0.768038,0.411721,-1.077763,0.045863,0.290136])    
#orb[5].guess = array([1.334561,0.768038,0.411721,-1.077763,0.045863,0.290136])
#orb[6].guess = array([0.141962,0.8,1.466316,-1.199485,1,1]) 
...
#orb[9].guess = array([-3.3785345,1.03796059,2.50785159,2.28419328,-3.3785345,1.03796059])

orb[0].bounds = ([-6,6]) #Bounds for SZ and SZP
orb[1].bounds=([-1,-1,-6,-6,-1,-10],[1,2,6,6,6,6]) #Bounds for SZ and SZP
#orb[2].bounds = ([-1.5,3.5])   #Bounds for SZ and SZP
orb[2].bounds = ([-6,6])       #Bounds for DZP and TZTP
orb[3].bounds = ([-4,4])    #Bounds for SZ and SZP
orb[4].bounds = ([-6,3])    #Bounds for SZ and SZP
orb[5].bounds = ([-1.5,1.5]) #Bounds for DZP
#orb[6].bounds = ([-10,10]) #Bounds for SZ,SZP and DZP
orb[6].bounds = ([-1.5,1.5]) #Bounds for DZP
orb[7].bounds=([-5,4])    #Bounds for TZTP
orb[8].bounds=([-6,6])    #Bounds for TZTP
orb[9].bounds = ([-6,6])  #Bounds for TZTP
