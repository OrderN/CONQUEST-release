...
#orb[0].bounds = ([-6,6])
orb[1].bounds = ([-6,2.5])  #Bounds for SZ,SZP,DZP,TZTP
orb[2].bounds = ([-6,6])    #Bounds for SZ,SZP,DZP,TZTP
orb[3].bounds = ([-6,3.5]) #Bounds for SZP,DZP,TZTP
