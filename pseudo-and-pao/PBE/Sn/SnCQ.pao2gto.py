...
#orb[2].guess = array([0.173667,0.737546,2.041271,2,1.943546,-1])
...
orb[3].bounds = ([-6,10])   #Bounds for SZP,DZP,TZTP
orb[4].bounds = ([-6,6])    #Bounds for DZP,TZTP
orb[5].bounds=([-1,-6,1,-6,0,-6],[3.5,1.5,4,6,6,6])   #Bounds for DZP,TZTP
orb[6].bounds = ([-1,3.5])  #Bounds for TZTP
orb[7].bounds=([-6,6])  #Bounds for TZTP
