...
orb[2].guess = array([0.8501192602, 1.2233905431,2.7143718397,-0.2790125744,0.2450817667,0.3042421013])
...
#   bounds = [(2,3),(-6,4),(0.0,-0.6)] #Bounds for a,d and c
    param, nG = gto_fit_orb( x, y, orb[i].nG, orb[i].guess, orb[i].n, orb[i].lname, orb[i].z, i, 
                            center=center, maxfev=20000 ,bounds=orb[i].bounds, method='dogbox')
