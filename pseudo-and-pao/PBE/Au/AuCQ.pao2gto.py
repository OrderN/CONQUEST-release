...
#orb[6].guess = array([1.334561,0.768038,0.411721,-1.077763,0.045863,0.290136])
...
orb[0].bounds = ([-6,6])    #Activation on SZ
orb[1].bounds = ([-6,6])    #Activation on SZ
#orb[2].bounds = ([-10,10])
#orb[3].bounds = ([-4,4])
#orb[4].bounds = ([-4,6])    #Activation on SZP  
#orb[5].bounds = ([-10,10])
#orb[6].bounds = ([-4,4])    #Activation on DZP
#orb[7].bounds=([-5,4])
#orb[8].bounds=([-4,4])
#orb[9].bounds = ([-6,6])
#orb[10].bounds = ([-6,6])
