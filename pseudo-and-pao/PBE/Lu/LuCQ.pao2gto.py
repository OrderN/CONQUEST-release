...
#orb[1].guess = array([1.334561,0.768038,0.411721,-1.077763,0.045863,0.290136])
#orb[2].guess = array([1.155396,0.423250,0.501348,-0.663974,0.031197,0.198817])  
...
#orb[9].guess = array([1.774463,0.364851,1.036166,-1.341885,0.089941,0.145736])
...
orb[2].bounds = ([-6,6])                           #Bounds for DZP,TZTP
orb[3].bounds = ([-4,4])                           #Bounds for ,SZP,DZP,TZTP
orb[4].bounds = ([-6,3])                           #Bounds for SZP,DZP,TZTP
orb[5].bounds = ([-4,4])                           #Bounds for DZP,TZTP
orb[6].bounds = ([-4,4])                           #Bounds for DZP,TZTP
#orb[7].bounds=([-5,4])                             #Bounds for TZTP
#orb[8].bounds=([-6,6])                             #Bounds for TZTP
#orb[9].bounds = ([-6,6])                           #bounds for TZTP
#orb[10].bounds = ([-6,6])                          #bounds for TZTP
