...
filename_gto_write='NaCQ.gto_SZ_3G' 
# file to read in order to build an initial guess (not mandatory)
filename_gto_read ='NaCQ.gto_SZ_3G_guess' 
...
#orb[2].guess = array([10.,-0.059096,1.532998,-1.970907,0.147241,0.265431])
...
orb[2].bounds = ([-10,10]) #SZ,SZP,DZP,TZTP
