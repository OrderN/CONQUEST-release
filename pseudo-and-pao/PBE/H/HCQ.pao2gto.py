...
filename_gto_write='HCQ.gto_DZP_3G' 
# file to read in order to build an initial guess (not mandatory)
filename_gto_read ='HCQ.gto_DZP_3G_guess' 
...
#orb[1].guess = array([1.170302,2.838355,2,0.384473,1,1])
#orb[2].guess = array([1.170302,2.838355,2.0,2.0,2.0,2.0])
...
#orb[5].guess = array([1.170302,2.838355,2,0.384473,1,1])




orb[1].bounds = ([-10,10])                          #Bounds for SZ,SZP,DZP,TZTP
orb[2].bounds=([-1,-6,-2,-6,0,-6],[3.5,3,4,6,6,6])  #Bounds for SZP,DZP,TZTP
#orb[5].bounds=([-1,-6,-2,-6,0,-6],[3.5,3,4,6,6,6])  #Bounds for TZTP
