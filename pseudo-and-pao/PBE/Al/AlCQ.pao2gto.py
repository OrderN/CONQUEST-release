...
filename_gto_write='AlCQ.gto_DZP_2G_guess' 
# file to read in order to build an initial guess (not mandatory)
#filename_gto_read ='AlCQ.gto_DZP_2G_guess' 
...
#orb[0].guess = array([ 0.1,-1.5,-1,1,1,1,1,1,1])
orb[1].guess = array([ 0.5,0.1,0.5,-0.1,0.5,-0.1])
# orb[2].guess = array([ 0.1,-1.5,-1,1,1,1])
# orb[3].guess = array([1, -2, 0.01, 0.4, 0.2, 2.5])
#orb[4].guess = array([ 0.5,0.1,0.5,-0.1])
...
orb[1].bounds=([0.,0.,0.,-1.4,0,-0.5],[2.0,1.2,3.0,0.0,3.0,0])
