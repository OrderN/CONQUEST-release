...
filename_gto_write='AlCQ.gto_SZ_3G' 
# file to read in order to build an initial guess (not mandatory)
filename_gto_read ='AlCQ.gto_SZ_3G_guess' 
...
#orb[1].guess = array([ 0.057896,0.091634,0.40,0.400,0.1,0.1])   
#orb[1].guess = array([0.071943,0.047778,0.4,0.237344,0.1,0.1])
#orb[0].guess = array([-1, 0.1, 0.5, -0.1,1,1])
#orb[0].guess = array([ 0.1,-1.5,-1,1])
#orb[0].guess = array([ -0.4,0.1,0.4,-0.1])
...
#orb[4].guess = array([2.791398, 0.307564, 0.223091,0.452752,1.79,3])
#orb[5].guess = array([2.791398, 0.307564, 0.223091,0.452752,1.79,4])
#orb[6].guess = array([2.791398, 0.307564, 0.223091,0.452752,1.79,4])
