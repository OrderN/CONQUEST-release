...
#orb[0].guess = array([0.088642,0.334162,0.508402,-0.277209,0.408853,2.068264])
#orb[1].guess = array([0.088642,0.334162,0.508402,-0.277209,0.408853,2.068264])  
#orb[2].guess = array([1.0,0.389613,0.389613,0.054788,0.1,0.1])
#orb[3].guess = array([2.791398, 0.307564, 0.223091,0.452752,1.79,4])    #For SZP
#orb[4].guess = array([2.791398, 0.307564, 0.223091,0.452752,1.79,4])
#orb[5].guess = array([2.791398, 0.307564, 0.223091,0.452752,1.79,4])
...
#orb[4].bounds=([-2,4])       #Bounds for DZP,TZTP
#orb[5].bounds=([-2,4])       #Bounds for TZTP
#orb[6].bounds=([-1.5,10])    #Bounds for TZTP
#orb[7].bounds=([-1.5,10])    #Bounds for TZTP
#orb[8].bounds=([-1.5,10])    #Bounds for TZTP
...
for i in range(norb):
    ...
    param, nG = gto_fit_orb( x, y, orb[i].nG, orb[i].guess, orb[i].n, orb[i].lname, orb[i].z, i, 
                            center=center, maxfev=2000, bounds=orb[i].bounds, method='trf')
