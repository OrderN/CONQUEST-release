...
#orb[9].guess = array([0.141962,0.8,1.866316,-1.199485,1,1])
#orb[9].guess = array([ 0.1,-1.5,-1,1,1,1])
#orb[10].guess = array([0.141962,0.8,1.866316,-1.199485,1,1])

orb[0].bounds = ([-6,6])
orb[1].bounds=([-1,-1,-6,-6,-1,-10],[1,2,6,6,6,10])
#orb[2].bounds = ([-10,10])
#orb[3].bounds = ([-4,4])
#orb[4].bounds = ([-10,10])
#orb[5].bounds = ([-10,10])
