...
filename_gto_write='MgCQ.gto_TZTP_3G' 
# file to read in order to build an initial guess (not mandatory)
filename_gto_read ='MgCQ.gto_TZTP_3G_guess' 
...
#orb[0].guess = array([1.227737, 2,2,1,1,0.211741])
#orb[1].guess = array([1.227737, 2,2,1,1,0.211741])
#orb[2].guess = array([1.227737, 2,2,1,1,0.211741])
#orb[1].guess = array([ 0.1,-1,5,-1,1,1])
#orb[2].guess = array([ 0.1,-1,5,-1,1,1])
#orb[3].guess = array([1.227737, 2,2,1,1,0.211741])
#orb[4].guess = array([ 0.1,-1,5,-1,1,1])
#orb[4].guess = array([1.227737, 2,2,1,1,0.211741])
#orb[5].guess = array([1.227737, 2,2,1,1,0.211741])
...
for i in range(norb):
    ...
    center = False
    param, nG = gto_fit_orb( x, y, orb[i].nG, orb[i].guess, orb[i].n, orb[i].lname, orb[i].z, i,maxfev=9000000,center=center )
    #
