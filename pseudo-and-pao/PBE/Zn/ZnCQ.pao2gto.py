...
filename_gto_read ='ZnCQ.gto_TZTP_2G_3G_guess' 
...
orb[6].bounds = ([-4,3])   #Bounds for TZTP 
orb[7].bounds = ([-6,6])     #Bounds for TZTP
orb[8].bounds=([-1,-6,2,-6,-1,-6],[6,2.6,3,3,6,6])     #Bounds for TZTP
orb[9].bounds=([-1,-6,2,-6,-1,-6],[2,2.6,6,3,6,6])     #Bounds for TZTP
orb[10].bounds = ([-10,10])  #Bounds for TZTP
