...
#orb[5].guess = array([1.232777,0.4,2.265454,0.190551])
orb[5].guess = array([0.155396,0.423250,0.7,-0.663974]) 

orb[0].bounds = ([-6,2.5])
orb[1].bounds=([-1,-1,-6,-6,-1,-10],[1,2,6,2,6,6])
#orb[2].bounds = ([-6,2.5])
orb[3].bounds = ([-10,10])
#orb[4].bounds=([-1,-1.5,-6,-6,-1,-6],[3.5,2,6,3,6,1])
orb[5].bounds=([-1,-1,0,-6],[6,6,0.7,3])
