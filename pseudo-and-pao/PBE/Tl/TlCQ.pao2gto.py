...
#orb[1].guess = array([1,1,0.99998303,1,1,1])
#orb[2].guess = array([1.36797553,0.10171453,-1.20247755,0.10162326,-0.06146171,1.03103223])  
#orb[3].guess = array([1.36797553,0.10171453,-1.20247755,0.10162326,-0.06146171,1.03103223])
#orb[4].guess = array([1.36797553,0.10171453,-1.20247755,0.10162326,-0.06146171,1.03103223])    
#orb[5].guess = array([1.334561,0.768038,0.411721,-1.077763,0.045863,0.290136])
#orb[6].guess = array([1.36797553,0.10171453,-1.20247755,0.10162326,-0.06146171,1.03103223])
...
#orb[9].guess = array([3.155396,0.423250,2.501348,-0.663974,0.031197,0.198817])

orb[0].bounds = ([-6,6])     #Bounds for SZ,SZP,DZP,TZTP 
orb[1].bounds=([-1,-1,-6,-6,-1,-10],[1,2,6,6,6,6])    #Bounds for SZ,SZP,DZP,TZTP 
orb[2].bounds = ([-6,6])     #Bounds for SZ,SZP,DZP,TZTP 
orb[3].bounds = ([-6,6])     #Bounds for SZP,DZP,TZTP 
orb[4].bounds = ([-6,6])     #Bounds for DZP,TZTP 
orb[5].bounds = ([-6,6])     #Bounds for DZP,TZTP 
