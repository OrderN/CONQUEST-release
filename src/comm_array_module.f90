...
!%%! 
!%%!     mynode=myid+1
!%%!     write(io_lun,*) ' In check_commarray_real called from ',name, &
!%%!          '  node no. = ',mynode,  &
...
!%%!        write(io_lun,*) ' ERROR in check_commarray_real called from',name
!%%!        write(io_lun,*) '  node no. = ',mynode,'  mx_send_in,mx_send_real = ' &
!%%!             ,mx_send_in,mx_send_real
!%%!        ierr=1
!%%!     endif
!%%!     if(mx_recv_in > mx_recv_real) then
!%%!        write(io_lun,*) ' ERROR in check_commarray_real called from',name
!%%!        write(io_lun,*) '  node no. = ',mynode,'  mx_recv_in,mx_recv_real = ' &
...
!%%! 
!%%!     mynode=myid+1
!%%!     write(io_lun,*) ' In check_commarray_int called from ',name, &
!%%!          '  node no. = ',mynode,  &
...
!%%!        write(io_lun,*) ' ERROR in check_commarray_int called from',name
!%%!        write(io_lun,*) '  node no. = ',mynode,'  mx_send_in,mx_send_int = ' &
!%%!             ,mx_send_in,mx_send_int
!%%!        ierr=1
!%%!     endif
!%%!     if(mx_recv_in > mx_recv_int) then
!%%!        write(io_lun,*) ' ERROR in check_commarray_int called from',name
!%%!        write(io_lun,*) '  node no. = ',mynode,'  mx_recv_in,mx_recv_int = ' &
