...
!TM
    ...
    if(new_format) then
       ...
       ! Read basis set
       basis_string = fdf_string('Basis.BasisSet','PAOs')
 ...
 ! For ghost atoms
    if(flag_ghost) then
       ...
       tmp = fdf_string('General.EnergyUnits','Ha')
       ...
       tmp = fdf_string('General.DistanceUnits','bohr')
...
51  format(2x,i4,' symmetry inequivalent Kpoints in Cartesian ')
52  format(6x,' (inverse Angstrom) form: ')
6   format(2x,'Kpt: ',i4,' : ',3f12.8,' Weight: ',f10.6)
7   format(2x,' All ',i4,' Kpoints in fractional coordinates: ')
8   format(/2x,'***WARNING***',/,2x,'No Kpoint mesh found - defaulting to Gamma point')
9   format(/2x,'***WARNING***',/,2x,'Specified Kpoint mesh shift in fractional coords >= 1.0.')
10  format(2x,i4,' symmetry inequivalent Kpoints in fractional coordinates: ')
