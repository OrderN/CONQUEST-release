...
dft_rforce = np.loadtxt('tmp.force')

fig, ax1 = plt.subplots(figsize=(8,6))

color1 = 'tab:blue'
ax1.plot(dft_energy,"o-", color=color1, label="Energy")
ax1.set_xlabel('a# iteration',size=12)
...
color2 = 'tab:red'
ax2 = ax1.twinx()
ax2.plot(dft_rforce, 's--', color=color2, label='Force')
ax2.set_ylabel('Force Residual [Ha/Bohr]', color=color2, size=12)
