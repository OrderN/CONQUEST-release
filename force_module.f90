...
contains
  ...
  !!   contains h_on_atomf (as generated by get_H_matrix) so should be
  !!   first (or should regenerate h_on_atomf).  get_KE_force
...
!****lat>$
    ...
    ! This ASSUMES that H_on_atomf contains the values of H
...
!****lat>$    
    ...
    if (test) then
       ...
       call get_electronic_density(density, electrons, supportfns, &
                                   ...
                                   maxngrid)
       ! H_on_atomf is given the correct values after calls of
       ! get_H_matrix
    ...
    ! N.B. IT IS VITAL TO HAVE H_on_atomf to storing the H (and
...
!    ! to avoid doing the onsite terms
    ...
    if (flag_basis_set == blips) then
       ...
       do grad_direction = 1, 3
          ...
          call blip_to_grad_new(inode-1, grad_direction, H_on_atomf(1))
