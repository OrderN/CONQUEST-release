...
c     unit vectors
      ...
      print*, 'rdcqd: unit vectors'
      
      if (getlin(0).eq.1) then
         if (.not.gnreal(v1,3,.false.)) goto 100
         print*, 'rdcqd v1'
         r(1) = vlen(v1)
         !print*, 'rdcqd r1', r(1),  vlen(v1)
      else
         goto 100
      endif
...
c     get atom number and types
      ...
      if (getlin(0).eq.1) then
         ...
         if (ktype.eq.2) then
            natoms = itype
            !
            print*, 'rdcqd ktype', ktype
            print*, 'rdcqd itype', itype
            print*, 'natoms =', natoms 
         end if
         !
         do while(.true.)
